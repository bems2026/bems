...
export interface Capabilities {
   ...
   */
  /** RM-068: the coldest ROOM TARGET this site permits an automatic rule to aim for. Optional
   * because a proxy that predates phase35 serves only the legacy key below. */
  acu_min_room_target_c?: number | null;
  /** The pre-RM-068 name for the same number, still served for one release. */
