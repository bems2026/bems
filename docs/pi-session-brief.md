...
| `ibems-ingest` | `server/ingest.mjs`, `server/reports.mjs`, `server/retention.mjs`, `server/ingestCycle.mjs`, `server/shapeRows.mjs`, `server/scrubTelemetry.mjs`, `server/readingCapabilities.mjs`, `server/healthRow.mjs`, `server/anomalyStats.mjs`, `server/fleetAlarm.mjs`, `server/supabaseRest.mjs`, `server/reportNotice.mjs` |
