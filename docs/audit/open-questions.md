...
evidence: [E-012, E-023, E-027, E-029, E-034, E-038, E-045, E-058, E-084, E-090]
---
...
| Q-03 | Does a copy of `flows_cred.json`, the Node-RED `credentialSecret`, `server/data/device-credentials.json` or `server/.env` exist anywhere other than the edge's SD card? | F-002. It decides whether losing the card is recoverable. | Operator | Say yes or no, and where (for example a password manager or institution storage). Give no values. | F-002; `X3-operations.md` backup |
